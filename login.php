...
<body style="background-color:#f7ebe6">
    <?php include 'nav.php' ?>
    <div class="w3-card-4 " style="max-width:600px; margin:auto; margin-top:17vh;padding:30px; border-radius:60px;background-image:linear-gradient(#e4eaf5,#f7f7dc)">
    <h1 style="margin-left:170px;margin-top:10px; margin-bottom:20px; font-size:50px;"><b><i><u>Login</u></i></b></h1>
    <form action="#">
        ...
        <input type="submit" value="Login!" class="w3-btn w3-blue" style="padding:10px;font-size:30px;border-radius:10px;margin-top:15px;font-family:cursive;" >
    </form>
    </div>
